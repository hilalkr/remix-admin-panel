...
import { createCity } from "~/services/cities.server";
...
import styles from "./NewCity.module.css";
...
export default function NewCity() {
  ...
  return (
    <div>
      <h2 className={styles.title}>{t("cities.addCity")}</h2>
